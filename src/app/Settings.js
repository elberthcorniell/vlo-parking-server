                        ...
                        <Card style={{ height: 'fit-content' }}>
                            <Card.Body>
                                ...
                                <div style={{ position: 'absolute', top: 10, right: 10 }}>
                                    <Button className="btn-tab" onClick={() => { this.setState({ show: true }) }}><strong>View all</strong></Button>
                                </div>
                                <Modal show={this.state.show} onHide={() => this.setState({ show: false })}>
                                    <Modal.Header>
                                        <strong>Account Activity</strong>
                                        <div style={{ zIndex: 5, width: 'fit-content', height: 'fit-content', position: 'absolute', top: 10, right: 10, cursor: 'pointer' }} onClick={() => this.setState({ show: false })}>
